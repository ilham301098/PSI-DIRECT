...
if(isset($_POST['btnLogin'])){
    ...
    if(!empty($errors)){ 
        ...
        $msg.='A couple of fields are not filled in correctly..';
        $msg.='<ul>';
        ...
        if(!$result) {
            ...
            $msg.='Something went wrong while signing in. Please try again later.';
            ...
            if(mysqli_num_rows($result) == 0){
                $msg.='You have supplied a wrong user/password combination. Please try again.';
            }else{
                ...
                $msg.='<br><div class="alert alert-success">Welcome, ' . $_SESSION['user_name'] . '. <a href="forum_diskusi.php">Proceed to the forum overview</a>.</div>';
            }
        }
    }
}
