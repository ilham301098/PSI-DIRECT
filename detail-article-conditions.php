            ...
            <div class="row">
                ...
                <div class="news content">
                    ...
                    <?php
                        ...
                        $sql = 'SELECT * FROM artikel_c WHERE id ='.$_GET['id'];
                ...
                <div class="col-5 col-md-12">
                    <div class="sidebar">
                        <div class="popular-posts">
                            ...
                            <ul class="p-0">
                                <?php
                                $result = mysqli_query($con,"SELECT * FROM artikel_c ORDER by id DESC LIMIT 3");
                                foreach ($result as $key) { ?>
                                <li class="d-flex flex-wrap justify-content-between align-items-center">
                                    <figure><a href="detail-article-conditions.php?id=<?php echo $key['id']; ?>"><img src="images/pemulihan/<?php echo $key['image']; ?>" alt="" width="100%" height="100%"></a></figure>

                                    <div class="entry-content">
                                        <h3 class="entry-title"><a href="detail-article-conditions.php?id=<?php echo $key['id']; ?>"><b><?php echo $key['judul']; ?></b></a></h3>
