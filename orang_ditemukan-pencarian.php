  	...
  	// execute query
		...
		<form action="" method="POST" enctype="multipart/form-data">
			...
			<div class="row justify-content-center">
				...
				<div class="col-sm-5">
					<div class="form-group">
						<label for="exampleInputFoto">Foto Orang yang Ditemukan</label>
			...
			<div class="row justify-content-center">
				...
				<div class="col-sm-5">
					<div class="form-group">
						<label for="exampleInputKondisiKorban">*Kondisi Orang yang Ditemukan</label>
				...
				<div class="col-sm-5">
					<div class="form-group">
						...
						<input type="date" name="tgl_ditemukan" value="" class="form-control" required="">
					</div>
				</div>
