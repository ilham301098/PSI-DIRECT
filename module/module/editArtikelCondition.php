...
$id=$_GET['id'];
$row=mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM artikel_c WHERE id='".$id."'"));
?>
					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<ul class="breadcome-menu">
								...
								<li>
									<a href="?module=artikel-condition">Artikel</a>
								</li>
							</ul>
						</div>
					</div>
	...
	<div class="sparkline12-list mt-b-30">
		<div class="sparkline12-hd">
			<div class="main-sparkline12-hd">
				<h1 align="center">Edit Artikel Post-Dissaster Condition</h1>
			</div>
		</div>
		<form action="?module=artikel-condition" method="post" enctype="multipart/form-data">
			<div class="row">
