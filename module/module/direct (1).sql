...
--
-- Host: 127.0.0.1
-- Generation Time: 20 Mei 2019 pada 07.33
...
(1, 'Tes', 'TesTes', 'Tes', '', '2019-05-20 12:23:08'),
(2, 'Tes2', 'Tes2', 'Tes2', '', '2019-05-20 00:00:00');
...
(8, 'test', '', 'youtube.com', 'TEST', 1, '2019-05-20 12:02:32', 0);
...
CREATE TABLE `video_p` (
  ...
  `JUDUL_P` varchar(36) NOT NULL,
  `LINK_P` text NOT NULL,
  `SUMBER_P` varchar(72) NOT NULL,
  `KATEGORI_P` int(3) NOT NULL,
  `DATE_CREATED` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `CREATED_BY` int(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `video_pemulihan` (
  ...
  `Judul_vp` varchar(36) NOT NULL,
  `Link_vp` varchar(144) NOT NULL,
  `Sumber_vp` varchar(72) NOT NULL,
  `Kategori_vp` varchar(36) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `video_pemulihan` (`ID_vp`, `Judul_vp`, `Link_vp`, `Sumber_vp`, `Kategori_vp`) VALUES
(1, 'Taubat penghilang trauma', 'https://www.youtube.com/watch?v=hcNp2zPT40E', 'Youtube', '1'),
(2, 'tes', 'tes', 'tes', ''),
(3, 'tes', 'tes', 'tes', ''),
(4, 'tes', 'tes', 'tes', ''),
(5, 'tes', 'testest', 'tes', '');
...
--
ALTER TABLE `video_p`
  MODIFY `ID_P` int(12) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `video_pemulihan`
--
ALTER TABLE `video_pemulihan`
  MODIFY `ID_vp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
--
