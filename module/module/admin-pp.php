...
<div class="analytics-sparkle-area">
    ...
    <tr>
        ...
        <td width ="350px" align = "center">Judul</td>
        <td width ="350px" align = "center">Aksi</td>
    </tr>
    <tr>
        <td width ="40px" align = "center">1</td>
        <td width ="150px" align = "center">Pertolongan Pertama pada Asma</td>
         <td width ="200px" height ="50px" align = "center"><button type="button" class="btn btn-custon-four btn-default"><a href="?module=edit-pp">Edit</a></button> <button type="button" class="btn btn-custon-four btn-default" data-toggle="modal" data-target=".bs-modal-DeleteArticle">Delete</button><button type="button" class="btn btn-custon-four btn-default" data><a href="pp-detail.php">Pratinjau</a></button></td>
    </tr>
    <tr>
        <td width ="40px" align = "center">2</td>
        <td width ="150px" align = "center">Pertolongan Pertama pada Diare</td>
         <td width ="200px" height ="50px" align = "center"><button type="button" class="btn btn-custon-four btn-default">Edit</button> <button type="button" class="btn btn-custon-four btn-default">Delete</button> <button type="button" class="btn btn-custon-four btn-default">Pratinjau</button></td>
    </tr>
</table>
<br>
