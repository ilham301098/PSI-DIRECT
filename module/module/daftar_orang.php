<?php
  ...
  $data_orang_hilang = mysqli_query($db, "SELECT * FROM orang_hilang WHERE status='Terverifikasi'");
  $data_orang_ditemukan = mysqli_query($db, "SELECT * FROM orang_ditemukan WHERE status='Terverifikasi'");
				...
				<div class="sparkline12-list mg-b-30">
					...
					// Delete
						if(isset($_POST['btnDeleteHilang'])){
							...
							$del=mysqli_query($db,$queryDelHilang);
							if($del){
									echo "Berhasil";
							}else{
									echo "Gagal";
					...
					// Edit
						if(isset($_POST['btnEditHilang'])){
							...
							// Initialize message variable
								...
								$editHilang=mysqli_query($db, $queryEdtHilang);
								if($editHilang){
									echo "Berhasil";
								}else{
										echo "Gagal";
					...
					// Add New
						if(isset($_POST['btnAddHilang'])){
							...
							// Initialize message variable
								...
								$addHilang=mysqli_query($db, $queryAddHilang);
								if($addHilang){
									echo "Berhasil";
								}else{
										echo "Gagal";
				...
				<div class="sparkline12-list mg-b-30">
					...
					// Delete
						if(isset($_POST['btnDeleteDitemukan'])){
							...
							$del=mysqli_query($db,$queryDelDitemukan);
							if($del){
									echo "Berhasil";
							}else{
									echo "Gagal";
					...
					// Edit
						if(isset($_POST['btnEditDitemukan'])){
							...
							// Initialize message variable
								...
								$editDitemukan=mysqli_query($db, $queryEdtDitemukan);
								if($editDitemukan){
									echo "Berhasil";
								}else{
										echo "Gagal";
							...
							$status = "Terverifikasi";
	  						...
	  						VALUES ('$nama', '$usia', '$gender', '$ciri', '$lokasi_ditemukan', '$tgl_ditemukan', '$jenis_bencana',
	   						'$nama_pelapor', '$no_telp_pelapor', '$kondisi_korban', '$foto', '$status')";
								...
								$addDitemukan=mysqli_query($db, $queryAddDitemukan);
								if($addDitemukan){
									echo "Berhasil";
								}else{
										echo "Gagal";
