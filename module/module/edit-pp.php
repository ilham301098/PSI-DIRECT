...
<div class="analytics-sparkle-area">
	<div class="container-fluid">
        ...
        <form>
          <input type="text" name="" placeholder="Judul" value="Pertolongan Pertama pada Asma" style="width: 100%;padding: 10px;"><br><br>
    ...
    <i>Sumber : id.wikihow.com/Mengatasi-Serangan-Asma</i></textarea><br>
         </form>
