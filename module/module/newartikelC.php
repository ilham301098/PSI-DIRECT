		...
		<form action="" method="post" enctype="multipart/form-data">
			<div class="row">
				...
				if (isset($_POST['upload'])){
					...
					$cek=mysqli_fetch_assoc(mysqli_query($con,"SELECT MAX(id)AS MAX FROM artikel_c"));
					$idn=$cek['MAX'];
					...
					$sql = "INSERT INTO artikel_c (judul, sumber, isi, image, date, kategori) VALUES ('$judul', '$sumber', '$isi', '$image', '$date', '$kategori')";
