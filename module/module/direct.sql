...
--
-- Host: 127.0.0.1
-- Generation Time: 16 Mei 2019 pada 09.14
...
--
-- Struktur dari tabel `artikel_pemulihan`
--

CREATE TABLE `artikel_pemulihan` (
  `ID_ap` int(12) NOT NULL,
  `Judul_ap` varchar(25) NOT NULL,
  `Kategori_ap` varchar(25) NOT NULL,
  `Deskripsi_ap` text NOT NULL,
  `Sumber_ap` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `artikel_pemulihan`
--

INSERT INTO `artikel_pemulihan` (`ID_ap`, `Judul_ap`, `Kategori_ap`, `Deskripsi_ap`, `Sumber_ap`) VALUES
(1, 'Tumbuhan layak makan', 'Post dissaster survival', 'BLablablablablabla', 'internet');
...
--
-- Struktur dari tabel `video_pemulihan`
--

CREATE TABLE `video_pemulihan` (
  `ID` int(12) NOT NULL,
...
--
-- Dumping data untuk tabel `video_pemulihan`
--

INSERT INTO `video_pemulihan` (`ID`, `Judul`, `Link`, `Sumber`) VALUES
(1, 'Tips menghilangkan Trauma', 'youtube.com', 'CNN news'),
(2, 'Cara survive di hutan', 'fiverr.com', 'Pemerintah'),
(3, 'Survive from the darkside', 'Google.com', 'Skinny Indonesia'),
(4, 'Nyobalagi', 'Google.com', 'Imajinasi liarku');
...
--
-- Indexes for table `artikel_pemulihan`
--
ALTER TABLE `artikel_pemulihan`
...
--
-- Indexes for table `video_pemulihan`
--
ALTER TABLE `video_pemulihan`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT for table `artikel_pemulihan`
--
ALTER TABLE `artikel_pemulihan`
  MODIFY `ID_ap` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
ALTER TABLE `video`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `video_pemulihan`
--
ALTER TABLE `video_pemulihan`
