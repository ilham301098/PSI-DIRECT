                        ...
                        <form action="" method="post" autocomplete="off">
                            <div class="modal-body">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="judul" value="<?php echo $res['JUDUL']; ?>" placeholder="Judul Video">
                                </div>
                                <br>
                                <div class="col-md-12">
                                    <label style="color:white;">Link</label>
                                    <input type="text" class="form-control" name="link" value="<?php echo $res['LINK']; ?>" placeholder="Link Video">
                                </div>
                                <br>
                                <div class="col-md-12">
                                    <label style="color:white;">Sumber</label>
                                    <input type="text" class="form-control" name="sumber" value="<?php echo $res['SUMBER']; ?>" placeholder="Sumber Video">
                                </div>
                                <br>
                                <div class="col-md-12">
